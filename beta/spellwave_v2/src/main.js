...
function updateEnvironment(seconds, delta) {
  if (mode === 'resting') {
    ...
    camera.position.y = 3.35 + Math.sin(seconds * 0.45) * 0.035;
    camera.position.z = -3.25;
    camera.lookAt(reusableVector.set(0.55, 1.5, -8.85));
...
function createRestScene() {
  ...
  wizard.add(blockMesh(0.95, 0.16, 0.66, robeTrimMat, 0, 0.34, 0.02));
  wizard.add(ellipsoidMesh(0.18, 0.16, 0.16, faceMat, -0.64, 1.0, 0.22, 14));
  wizard.add(ellipsoidMesh(0.18, 0.16, 0.16, faceMat, 0.64, 1.0, 0.22, 14));
  wizard.add(blockMesh(0.11, 0.11, 0.08, goldMat, -0.22, 0.8, 0.34));
  wizard.add(blockMesh(0.11, 0.11, 0.08, goldMat, 0.22, 0.62, 0.34));
  wizard.add(ellipsoidMesh(0.58, 0.54, 0.52, faceMat, 0, 1.55, 0.03, 20));
  wizard.add(ellipsoidMesh(0.62, 0.34, 0.2, beardMat, 0, 1.28, 0.32, 18));
  wizard.add(cylinderMesh(0.42, 0.42, 0.18, hatMat, 0, 1.88, 0.02, 20));
  wizard.add(coneMesh(0.34, 0.8, hatMat, 0, 2.3, 0.02, 20));
  wizard.add(cylinderMesh(0.43, 0.43, 0.05, robeTrimMat, 0, 1.94, 0.02, 20));
  wizard.add(blockMesh(0.12, 0.12, 0.08, stoneDarkMat, -0.16, 1.62, 0.28));
  wizard.add(blockMesh(0.12, 0.12, 0.08, stoneDarkMat, 0.16, 1.62, 0.28));
  wizard.add(blockMesh(0.18, 0.05, 0.08, browMat, -0.16, 1.74, 0.3));
  wizard.add(blockMesh(0.18, 0.05, 0.08, browMat, 0.16, 1.74, 0.3));
  wizard.add(ellipsoidMesh(0.09, 0.11, 0.08, faceMat, 0, 1.52, 0.36, 12));
  wizard.add(ellipsoidMesh(0.08, 0.045, 0.035, cheekMat, -0.26, 1.48, 0.36, 10));
  wizard.add(ellipsoidMesh(0.08, 0.045, 0.035, cheekMat, 0.26, 1.48, 0.36, 10));
  wizard.add(blockMesh(0.1, 0.1, 0.08, goldMat, -0.15, 2.24, 0.27));
  wizard.add(blockMesh(0.08, 0.08, 0.08, goldMat, 0.17, 2.44, 0.2));
  wizard.add(blockMesh(0.24, 0.68, 0.24, robeMat, -0.62, 0.95, 0.14));
  wizard.add(blockMesh(0.24, 0.68, 0.24, robeMat, 0.62, 0.95, 0.14));
  wizard.add(blockMesh(0.5, 0.28, 0.55, stoneDarkMat, -0.34, 0.18, 0.1));
  wizard.add(blockMesh(0.5, 0.28, 0.55, stoneDarkMat, 0.34, 0.18, 0.1));
  group.add(wizard);
  ...
  group.add(cylinderMesh(0.09, 0.11, 0.32, makeBasic(0xffd36e, 0.86), 0.82, 0.82, -5.82, 16));
  group.add(cylinderMesh(0.14, 0.14, 0.08, makeMat(0xf2f0df), 0.82, 0.62, -5.82, 16));
  ...
  for (let index = 0; index < steamSeeds.length; index += 1) {
    ...
    const puff = ellipsoidMesh(0.28, 0.18, 0.28, material, x, y, z, 14);
