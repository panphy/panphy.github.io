...
### Modular Architecture (PanPhyPlot Example)
...
**File**: `sw.js`
**Cache Version**: `panphy-labs-YYYY-MM-DD` (update date when modifying)
...
| `tools/panphyplot/` | Most complex tool, good reference for patterns |
